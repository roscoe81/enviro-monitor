...
## Note: Even though the accuracy of the Enviro Monitor has been improved, the readings are still not thoroughly and accurately calibrated. The calibration exercise has been undertaken for temperatues between 0 and 40 degrees Celsius, so it's unlikely to provide effective useful outside of that range. They readings should therefore not be relied upon for critical applications.
